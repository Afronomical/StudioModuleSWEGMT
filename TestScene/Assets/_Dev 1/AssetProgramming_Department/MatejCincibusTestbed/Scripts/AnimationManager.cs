...
public class AnimationManager : MonoBehaviour
{
    ...
    public List<AnimationStates> animationStatesList = new List<AnimationStates>();
    // List of all the names of animations that relate to this specific GO
    [SerializeField] private List<string> animationStringsList = new List<string>();
    ...
    [SerializeField] private Dictionary<AnimationStates, string> animationsDictionary = new Dictionary<AnimationStates, string>();
